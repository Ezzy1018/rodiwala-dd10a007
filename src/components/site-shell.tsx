...
export function SiteShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-background pb-18 md:pb-0">
          ...
          >
            {nav.map(([label, to]) => (
              <Link
                ...
                className="block border-b border-border py-3 font-display font-semibold text-foreground last:border-0"
              >
                {label}
              </Link>
            ))}
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-5 px-5 py-12 sm:flex-row sm:items-end sm:justify-between">
          <div className="footer-brand">
            ...
            <p className="mt-3 max-w-md text-sm text-primary-foreground/65">
              India bhar ki sites ke liye construction material sourcing. Har requirement par availability,
              delivered rate aur delivery feasibility check karke batayi jaati hai.
            </p>
          </div>
