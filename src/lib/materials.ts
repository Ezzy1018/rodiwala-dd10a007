...
export type Material = {
  slug: string;
  href: "/aggregate/10-mm-rodi" | "/aggregate/20-mm-rodi" | "/stone-dust" | "/m-sand" | "/ready-mix-concrete";
  name: string;
  shortName: string;
  image: string;
  description: string;
